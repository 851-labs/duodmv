...
export const section10Lessons: Lesson[] = [
	{
		...
		learnContent: [
			{
				...
				highlight: "No insurance? Your license can be suspended for up to 4 years after a collision!",
			},
			{
				id: "minimum-coverage",
				type: "text",
		...
		questions: [
			...
			},
			{
				...
				difficulty: 2,
				xpValue: 15,
				question: "How long can your license be suspended for driving without insurance after a collision?",
				options: [
					"Up to 4 years",
					"Up to 1 year",
					"6 months",
