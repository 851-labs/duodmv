...
export const section5Lessons: Lesson[] = [
	{
		...
		learnContent: [
			...
			},
			{
				...
				content: "Start signaling before you begin your maneuver to give other drivers time to react.",
				bulletPoints: [
		...
		questions: [
			...
			},
			{
				...
				xpValue: 15,
				question:
					"What does a left arm bent upward at 90 degrees out the window mean?",
				options: [
					"Right turn",
					"Left turn",
					"Slow or stop",
			...
			},
			{
				...
				xpValue: 15,
				statement:
					"On highways, you should signal at least 200 feet before turning.",
				isTrue: true,
				explanation:
	...
	},
	{
		...
		questions: [
			...
			},
			{
				...
				xpValue: 10,
				statement:
					"You should keep at least 10 inches between your chest and the steering wheel.",
				isTrue: true,
				explanation:
