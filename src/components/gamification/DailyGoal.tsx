  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-3">
        ...
        <span
          className={clsx("text-lg font-bold", isComplete ? "text-primary-600" : "text-zinc-600")}
        >
          {currentXp}/{goalXp}
        </span>
      </div>
      ...
      <div className="h-3 bg-surface-200 rounded-full overflow-hidden">
        <div
          className={clsx(
            ...
            isComplete ? "bg-primary-500" : "bg-gradient-to-r from-secondary-400 to-secondary-500",
          )}
