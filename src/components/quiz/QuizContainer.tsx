...
export function QuizContainer({ lesson, onComplete, onExit, streakDays }: QuizContainerProps) {
  ...
  const handleLessonComplete = useCallback(() => {
    ...
    const xpEarned = calculateLessonXp(lesson.xpReward, accuracy, isPerfect, streakDays);
  ...
  return (
    <div className="min-h-screen bg-surface-50 flex flex-col">
      ...
      <main className="flex-1 px-4 py-8 pb-32">
        <div className="max-w-2xl mx-auto">{renderQuestion(currentQuestion)}</div>
      </main>
